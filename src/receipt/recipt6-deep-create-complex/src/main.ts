...
async function createDummyPost(prisma: PrismaClient) {
...
async function updateDummyBedAdvertisment(prisma: PrismaClient) {
...
async function main() {
  ...
  await createDummyBedAdvertisment(prisma, user1.id);
